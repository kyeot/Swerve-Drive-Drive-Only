...
import org.usfirst.frc2783.messages.HeartbeatMessage;
import org.usfirst.frc2783.messages.OffWireMessage;
import org.usfirst.frc2783.messages.VisionMessage;
...
public class VisionServer extends CrashTrackingRunnable {
    ...
    protected class ServerThread extends CrashTrackingRunnable {
        ...
        public void send(VisionMessage message) {
            ...
            if (m_socket != null && m_socket.isConnected()) {
                try {
                    ...
                    Logger.warn("VisionServer: Could not send data to socket");
                }
            }
        }
        ...
        public void runCrashTracked() {
            ...
            try {
                ...
                Logger.error("Could not talk to socket");
            }
            if (m_socket != null) {
                try {
                    m_socket.close();
    ...
    private VisionServer(int port) {
        ...
        Logger.info("finished visionServer");
    }
    ...
    public void runCrashTracked() {
        while (m_running) {
            try {
                ...
                Logger.warn("Issue accepting socket connection!");
            } finally {
                try {
                    Thread.sleep(100);
